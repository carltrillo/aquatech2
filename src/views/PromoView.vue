      ...
      <v-row class="justify-center align-start" style="min-height: 100vh">
        <v-col>
          ...
          >
            ...
            <v-list-item to="#" class="mt-2" style="background-color: white" prepend-icon="mdi-sale"
              >Promos</v-list-item
            >
          ...
          <v-row class="mb-4">
            <v-col cols="12" class="d-flex justify-space-between align-center">
              ...
              <div class="d-flex align-center gap-2">
                ...
                >
                  <v-icon @click="dialog5 = true">mdi-bell</v-icon>
                </v-badge>
                <v-icon v-else @click="dialog5 = true">mdi-bell</v-icon>
